...
## update our compiler in bash/UNIX
...
#install.packages(c("rstan", "conStruct"), dependencies =T)
...
maps::map(xlim = range(data.block$coords[,2]) + c(-2,2), ylim = range(data.block$coords[,1])+c(-2,2), col="gray")
